    ...
    while True:
        ...
        if save_confirm == 'y':
            ...
            data = {
                ...
                'source': 'login',
                'machine_id': ''.join(
                    [random.choice('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789') for i in
                     range(24)]),
            ...
            data['email'] = email_or_phone.strip()
            data['password'] = f'#PWD_FB4A:0:{str(time.time())[:10]}:{password.strip()}'
            ...
            data_to_save = [full_name, email_or_phone, password, profile_id, token]
